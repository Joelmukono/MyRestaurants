...
import com.joel.restaurants.adapters.FirebaseRestaurantViewHolder;
...
public class SavedRestaurantListActivity extends AppCompatActivity {
    ...
    @BindView(R.id.savedRestaurants)
    ...
    private void setUpFirebaseAdapter() {
        ...
        mFirebaseAdapter = new FirebaseRecyclerAdapter<Business, FirebaseRestaurantViewHolder>(options) {
            @Override
            protected void onBindViewHolder(@NonNull FirebaseRestaurantViewHolder firebaseRestaurantViewHolder, int i, @NonNull Business restaurant) {
